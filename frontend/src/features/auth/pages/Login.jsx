      ...
      <div className="login-container">
        ...
        <div className="login-banner">
          ...
          <div className="banner-text">
            <h1>WELCOME BACK.<br />WEAR THE CULTURE.</h1>
            <p>Login to manage your cart, orders, and saved drops.</p>
          </div>
        ...
        <div className="login-form-section">
          ...
          <div className="login-card">
            ...
            <p className="subtitle">
              Enter your credentials to manage your cart, orders, and saved drops.
            </p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="proceed-btn" disabled={Loading}>
                {Loading ? 'Processing...' : 'PROCEED'} <span>→</span>
              </button>
            </form>
